...
.text
      addi $16, $0, 0x02000      # load address of array
      addi $21, $0, 0x0204c       # load address of size variable
...
#      add  $s5, $v0, $zero  # transfer the number to the desired register
      ...
      addi $18, $0, 0x00001          # 1 is the known value of first and second Fib. number
      sw   $s2, 0($s0)      # F[0] = 1
...
loop: lw   $s3, 0($s0)      # Get value from array F[n-2]
     ...
     addi $4, $0, 0x02000       # first argument for print (array)
      add  $a1, $zero, $s5  # second argument for print (size)
      jal  print            # call print routine. 

      # The program is finished. Exit.
      addi $2, $0, 0x000a        # system call for exit
      syscall               # Exit!
...
print:add  $t0, $zero, $a0  # starting address of array of data to be printed
      ...
      addi $4, $0, 0x02089        # load address of the print heading string
      addi $2, $0, 0x004          # specify Print String service
      syscall               # print the heading string
      
out:  lw   $a0, 0($t0)      # load the integer to be printed (the current Fib. number)
      addi $2, $0, 0x0001        # specify Print Integer service
      syscall               # print fibonacci number
      
      addi $4, $0, 0x02087      # load address of spacer for syscall
      addi $2, $0, 0x004         # specify Print String service
